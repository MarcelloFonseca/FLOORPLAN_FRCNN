...
CHECKPOINT = "floorplan_door_only2.pth"
# FP_PLANS = ["TEST-PLAN3.png", "TEST-PLAN4.png"]
FP_PLANS = ["TEST-PLAN9.png"]
OUT_DIR = Path("hard_negatives_raw")
...
det_model = AutoDetectionModel.from_pretrained(
    ...
    confidence_threshold=0.40, device=device,
...
for plan_path in FP_PLANS:
    ...
    result = get_sliced_prediction(
        plan_path, det_model, auto_slice_resolution=True,
    ...
    for i, obj in enumerate(result.object_prediction_list):
        ...
        crop.save(OUT_DIR / f"{stem}_det{i:03d}_score{obj.score.value:.2f}.png")

print(f"Généré dans {OUT_DIR} — trie maintenant manuellement.")